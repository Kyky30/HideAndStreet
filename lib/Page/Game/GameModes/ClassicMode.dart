...
import 'package:HideAndStreet/Page/Game/GameUtilities/GlobalUtilities.dart';
import 'package:HideAndStreet/Page/Game/GameUtilities/LocationUtilities.dart';
import 'package:HideAndStreet/Page/Game/GameUtilities/NotificationUtilities.dart';
...
import 'package:HideAndStreet/Page/Game/GameUtilities/TauntsUtilities.dart';
...
class _ClassicModeState extends State<ClassicMode> {
  ...
  void gameLoop() {
    ...
    Future.delayed(const Duration(seconds: 5), () async {
      ...
      tauntUtilities.updatePosition(currentPosition);
